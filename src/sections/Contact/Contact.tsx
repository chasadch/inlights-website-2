...
export default function Contact({
  ...
  return (
    <>
      ...
      {/* Contact 1024 pixels */}
      <section
        className="relative mx-auto hidden max-w-[1440px] flex-col items-center justify-between gap-[66px] overflow-hidden bg-black px-[16px] lg:flex lg:flex-row lg:items-start lg:px-[70px]"
        style={{
