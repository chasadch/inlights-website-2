...
export default function Contact() {
  ...
  return (
    <section className="flex flex-col items-center justify-between overflow-hidden bg-black px-[16px] py-[140px] sm:flex-row sm:items-start lg:px-[70px]">
      ...
      {/* Contact Form */}
      <div className="flex h-[747px] w-full flex-col items-center justify-center gap-[30px] rounded-[20px] bg-[#050919] px-[16px] py-[20px] shadow-shadowCustom sm:mt-0 lg:h-[522px] lg:w-[495px] lg:p-[36px] xl:w-[695px]">
