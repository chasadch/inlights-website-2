    ...
    >
      <div className="flex items-start gap-[10px] self-stretch">
        ...
        <div className="flex h-[541px] w-full items-center justify-between">
          {/* Child #1 (large block)  */}
          <div className="flex flex-shrink-0 flex-col items-end justify-center gap-[2.604px] py-[12.5px] pl-[12.5px] pr-[70px] lg:w-[432px] lg:gap-[10px] lg:p-[0px] xl:w-[532px] 2xl:w-[632px]">
          ...
          <div className="mr-[70px] flex flex-col items-center gap-[15px] lg:gap-[85px] xl:mr-[140px]">
            <div className="flex h-[200px] w-[200px] flex-col items-center justify-center gap-[12px] rounded-[52.083px] border-[0.26px] border-borderCustom bg-[#050919] px-[8.333px] py-[20px] shadow-shadowCustom lg:gap-[10px] lg:rounded-[200px] lg:border-[1px] lg:p-[32px] 2xl:h-[240px] 2xl:w-[240px]">
              <Image
