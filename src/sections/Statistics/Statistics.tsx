...
export default function Statistics() {
  return (
    <section
      className="bg-black bg-cover bg-center bg-no-repeat py-[70px]"
      style={{ backgroundImage: "url(/statistics/bg.png)" }}
    >
      <div className="flex items-start gap-[10px] self-stretch">
        {/* Added w-full so the parent’s justify-between works correctly */}
        <div className="flex h-[541px] w-full items-center justify-between">
          {/* Child #1 (large block)  */}
          <div className="flex flex-shrink-0 flex-col items-end justify-center gap-[2.604px] py-[12.5px] pl-[12.5px] pr-[70px] lg:w-[632px] lg:gap-[10px] lg:p-[48px]">
            <div className="flex h-[127px] w-[418px] flex-shrink-0 flex-col items-end justify-center gap-[2.604px] rounded-br-[39.063px] rounded-tr-[39.063px] bg-[linear-gradient(to_right,#4935FF,#020F12)] p-[48px] shadow-shadowCustom lg:h-[490px] lg:w-[776px] lg:gap-[10px] lg:rounded-br-[150px] lg:rounded-tr-[150px]">
