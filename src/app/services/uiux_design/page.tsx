    ...
    <div className="relative self-stretch bg-[#050919]">
      ...
      <div className="h-[687px] bg-[linear-gradient(0deg,rgba(9,17,33,0.12)_0%,rgba(9,17,33,0.12)_100%),url('/services/this_is_engineering_sm.png')] bg-cover bg-center bg-no-repeat sm:bg-[linear-gradient(0deg,rgba(9,17,33,0.32)_0%,rgba(9,17,33,0.32)_100%),url('/about/about_hero.png')] lg:min-h-screen">
        ...
        <div className="mx-auto flex h-[685px] w-full max-w-[1440px] flex-col gap-[16px] self-stretch pt-[100px] lg:h-[839.499px] lg:flex-row lg:items-center lg:justify-between lg:pr-[71.17px] lg:pt-0">
          ...
          >
            <div className="absolute right-[7.25rem] top-[1.75rem] z-20 h-[234px] w-[203px] flex-shrink-0 lg:right-[12rem] lg:top-[2.5rem] lg:h-[349px] lg:w-[280px] xl:right-[13rem] xl:h-[399px] xl:w-[330px] 2xl:right-[14rem] 2xl:h-[449px] 2xl:w-[380px]">
              <Image
            ...
            <div className="absolute right-[2.5rem] top-0 z-10 h-[261px] w-[203px] flex-shrink-0 lg:h-[403px] lg:w-[283px] xl:h-[453px] xl:w-[333px] 2xl:h-[503px] 2xl:w-[383px]">
              <Image
            ...
            <div className="absolute -right-[3.5rem] -top-[1.5rem] h-[283px] w-[193px] flex-shrink-0 lg:h-[422px] lg:w-[279px] xl:h-[472px] xl:w-[329px] 2xl:h-[522px] 2xl:w-[379px]">
              <Image
      ...
      {/* Tech section */}
      {/* <div className="flex w-full flex-col items-start justify-center gap-[10px] self-stretch bg-[url('/statistics/bg.png')] bg-cover bg-no-repeat py-[90px] lg:h-[681px]"> */}
          ...
          <div className="mx-auto grid gap-[26px] lg:grid-cols-2 xl:grid-cols-4">
            <div className="h-[201.964px] flex-shrink-0">
              <div className="relative flex-shrink-0">
                <div className="relative h-[169.568px] w-[267.348px] flex-shrink-0">
                  <Image
                ...
                <div className="absolute -top-[1.7rem] left-[3.5rem] flex items-center justify-center gap-2">
                  ...
                  <span className="ml-[10px] text-center font-lato text-[19px] font-medium xl:text-[24px]">
                    Ideate
                  </span>
                </div>
                ...
                <div className="absolute -top-[1rem] left-[2rem] h-[184px] w-[171px] flex-shrink-0">
                  <div className="inline-flex h-[184px] flex-shrink-0 flex-col items-center justify-end pb-[52px] pt-[93.82px]">
                    <div className="flex flex-col items-start gap-[9px]">
                      <p className="h-[52px] w-[153.744px] font-lato text-size-7 font-normal leading-none tracking-[0.36px] opacity-70">
            ...
            <div className="h-[202px] flex-shrink-0">
              <div className="relative flex-shrink-0">
                ...
                <div className="absolute -top-[1.7rem] left-[3.5rem] flex items-center justify-center gap-2">
                  <div className="relative h-[64px] w-[64px]">
                    <Image
                      src={"/services/uiux-design/email.png"}
                      alt="Bulb"
                      fill
                      className="object-cover"
                    />
            ...
            <div className="h-[202px] flex-shrink-0">
              <div className="relative flex-shrink-0">
                ...
                <div className="absolute -top-[1.7rem] left-[3.5rem] flex items-center justify-center gap-2">
                  <div className="relative h-[64px] w-[64px]">
                    <Image
                      src={"/services/uiux-design/create.png"}
                      alt="Bulb"
                      fill
                      className="object-cover"
                    />
            ...
            <div className="h-[202px] flex-shrink-0">
              <div className="relative flex-shrink-0">
                ...
                <div className="absolute -top-[1.7rem] left-[3.5rem] flex items-center justify-center gap-2">
                  ...
                  <span className="ml-[4px] text-start font-lato text-[19px] font-medium xl:text-[24px]">
                    User Testing
                  </span>
                </div>
