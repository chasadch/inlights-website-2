  ...
  return (
    <div className="relative self-stretch bg-black">
      ...
      <div className="relative self-stretch bg-black">
        ...
        <div
          className="h-[810px] w-full bg-cover bg-center px-[16px] pt-[119px] lg:px-[70px] lg:pt-[0px]"
          style={{
            background:
              "linear-gradient(0deg, rgba(9, 17, 33, 0.32) 0%, rgba(9, 17, 33, 0.32) 100%), url(/geohealth/geohealth_hero_lg.png) lightgray -0.05px 0px / 100.006% 102.599% no-repeat",
          }}
        >
          {/* Content Container: centered and max-w-[1440px] */}
          <div className="mx-auto flex h-full max-w-[1440px] items-center justify-between gap-[16px]">
      ...
      >
        <div className="mx-auto flex h-[681px] max-w-[1440px] flex-shrink-0 flex-col items-center justify-between pb-[70px] pt-[100px] lg:flex-row lg:pl-[70px] lg:pr-[70px]">
      ...
      {/* Stacks section */}
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-start gap-[26px] py-[100px] lg:gap-[40px] lg:px-[70px]">
