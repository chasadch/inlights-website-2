...
export default function GeoHealth() {
  return (
    <div className="relative self-stretch bg-black">
      {/* Hero Section */}
      <div
        className="h-[810px] w-full items-center justify-between gap-[16px] self-stretch bg-cover bg-center px-[16px] pt-[100px] lg:flex lg:px-[70px] lg:pt-[0px]"
        style={{
          background:
      ...
      >
        <div className="flex flex-col items-start gap-[49.727px]">
          <div className="flex w-[328px] flex-col items-start gap-[17.612px] xl:w-[746px]">
            ...
            <h1 className="text-[24px] font-bold leading-[32px] lg:w-[373px] lg:text-size-2 lg:leading-[94px] xl:w-[746px] xl:text-[65.58px]">
              GeoHealth
            </h1>
            <p className="text-size-7 font-normal opacity-70 lg:w-[438px] lg:text-size-4 xl:w-[638px]">
        ...
        {/* Image */}
        <div className="mx-auto h-[199.559px] w-[292.211px] flex-shrink-0 pt-[150px] lg:pt-[0px] xl:h-[249px] xl:w-[411px] 2xl:h-[349px] 2xl:w-[511px]">
      ...
      {/* Tech section */}
      <div className="flex w-full flex-col items-start gap-[40px] py-[50px] lg:px-[70px]">
