    ...
    <div className="relative self-stretch">
      ...
      <div className="bg-[url('/geohealth/bg.png')] bg-cover bg-center bg-no-repeat">
        ...
        {topicCustomization.map(({ title, description, image }, index) => (
          <div
            key={index}
            className="mx-auto flex h-[681px] max-w-[1440px] flex-shrink-0 flex-col items-center justify-between pb-[95px] pt-[95px] lg:h-screen lg:flex-row lg:items-center lg:justify-center lg:pb-0 lg:pl-[70px] lg:pr-[70px] lg:pt-0"
          >
